...
//    
    ...
    /**
     * <p>Función genérica para toda consulta: Necesita un paràmetro cuyo KEY
     * sea igual a where con la cadena de where</p>
     * <p>Necesita un parámetro ;orden on la cadena order by</p>
     *
     * <p>Necesita un paràmetro llamado ;inicial para rango inicial Necesita un
    ...
    public List<Object[]> sumar(Map parametros) throws ConsultarException {
        ...
        String sql = "Select " + campo + "," + suma + " from " + tabla + " as o " + where + grupo;
        javax.persistence.Query q = getEntityManager().createQuery(sql);
//        if (all) {
//            q.setMaxResults(maxResults);
//            q.setFirstResult(firstResult);
//        }
    ...
    /**
     * <p>Función genérica para toda consulta: Necesita un paràmetro cuyo KEY
     * sea igual a al nombre de una sentencia preparada</p>
     * <p>Necesita un parámetro ;orden on la cadena order by</p>
     *
     * <p>Necesita un paràmetro llamado ;inicial para rango inicial Necesita un
     * parámetro llamado ;final indicar el rango final</p>
